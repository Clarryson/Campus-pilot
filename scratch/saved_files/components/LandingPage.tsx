        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => onLaunchApp('dashboard')}>
            <div className="relative">
              <div className="absolute inset-0 bg-[#009BF5] rounded-xl blur-md opacity-25"></div>
              <div className="relative bg-[#0A1128] border border-[#009BF5]/30 p-2.5 rounded-xl text-[#009BF5]">
      ...
      <footer className="border-t border-slate-100 bg-[#0A1128] text-slate-400 px-6 py-12 text-xs">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-3 text-left">
            <div className="bg-white/10 p-2 rounded-xl text-[#009BF5] border border-white/10">
